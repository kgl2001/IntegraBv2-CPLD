REM CC64K(WWP2) 32k PALPROM Loader
...
FORn%=0TO(numbanks%-1)DIV2
FORb%=0TO3
s%=FNpartload(fh%,buffer%,(b%*&1000 + n%*&4000),&1000)
IFs%VDU8,8,8,8,8,8,8,7,129:PRINT"Failed"''"Error opening file":PROCResetFlags:END
FOR z%=0TO2STEP2
VDU8,8,8,8,8,8,8,131:PRINT;(n%+z%);"/";STR$~(&8000+b%*&1000);
?newrom=FNswram(n%+z%):?&70=buffer%MOD256:?&71=buffer%DIV256:?&72=0:?&73=&80+b%*&10:CALLsrload
NEXT:NEXT:NEXT
CLOSE#?osblock%
