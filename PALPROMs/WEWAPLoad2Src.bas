...
FORn%=cc%TO10:PRINT".";:NEXT:VDU131:PRINT"0/8000";
FORb%=0TO1
s%=FNpartload(fh%,buffer%,(b%*&1000),&1000)
...
FORb%=0TO1
FORn%=0TOnumbanks%-1
s%=FNpartload(fh%,buffer%,(b%*&1000 + n%*&2000),&1000)
IFs%VDU8,8,8,8,8,8,8,7,129:PRINT"Failed"''"Error opening file":PROCResetFlags:END
VDU8,8,8,8,8,8,8,131:PRINT;n%;"/";STR$~(&A000+b%*&1000);
?newrom=FNswram(n%):?&70=buffer%MOD256:?&71=buffer%DIV256:?&72=0:?&73=&80+(b%+2)*&10:CALLsrload
NEXT:NEXT
CLOSE#?osblock%
